...
insert into chapter (id, course_id, name) values ('00000009','00000001','测试大章09');
insert into chapter (id, course_id, name) values ('00000010','00000001','测试大章10');
insert into chapter (id, course_id, name) values ('00000011','00000001','测试大章11');
insert into chapter (id, course_id, name) values ('00000012','00000001','测试大章12');
insert into chapter (id, course_id, name) values ('00000013','00000001','测试大章13');
...
insert into role values ('00000000','系统管理员','管理用户、角色管理');
