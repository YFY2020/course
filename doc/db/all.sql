...
insert into chapter (id, course_id, name)
values ('00000002', '00000001', '测试大章02');
insert into chapter (id, course_id, name)
values ('00000003', '00000001', '测试大章03');
insert into chapter (id, course_id, name)
values ('00000004', '00000001', '测试大章04');
insert into chapter (id, course_id, name)
values ('00000005', '00000001', '测试大章05');
insert into chapter (id, course_id, name)
values ('00000006', '00000001', '测试大章06');
insert into chapter (id, course_id, name)
values ('00000007', '00000001', '测试大章07');
insert into chapter (id, course_id, name)
values ('00000008', '00000001', '测试大章08');
insert into chapter (id, course_id, name)
values ('00000009', '00000001', '测试大章09');
insert into chapter (id, course_id, name)
values ('00000010', '00000001', '测试大章10');
insert into chapter (id, course_id, name)
values ('00000011', '00000001', '测试大章11');
insert into chapter (id, course_id, name)
values ('00000012', '00000001', '测试大章12');
insert into chapter (id, course_id, name)
values ('00000013', '00000001', '测试大章13');
insert into chapter (id, course_id, name)
values ('00000014', '00000001', '测试大章14');
...
(
    ...
    `use`      char(1) comment '用途|枚举[FileUserEnum]:COURSE("C","讲师"),TEACHER("T","课程")',
    created_at datetime(3) comment '创建时间',
    updated_at datetime(3) comment '修改时间',
    primary key (id),
...
insert into role
values ('00000000', '系统管理员', '管理用户、角色管理');
insert into role
...
(
    ...
    resource_id char(6) not null comment '角色|id',
    primary key (id)
) engine = innodb
...
create  table sms(
    ...
    status char(1) not null comment '状态|枚举[SmsStatus]:USED("U","已使用"),NOT_USED("N","未使用")',
    primary key (id)
